			...
			<div class="d-flex flex-row flex-column-fluid page">
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">						
							...
							<div class="container">
								<div class="row">
                                    <div class="col-md-6">
                                        <div class="card card-custom gutter-b example example-compact">
                                                <div class="card-header">
                                                    <h3 class="card-title">Multiple Survey</h3>
                                                    
                                                </div>
												<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>hasil/send" enctype="multipart/form-data">
                                                    <div class="card-body">
                                                        <div class="form-group mb-8">
														<div class="form-group">
														<label>Pilih file excel sesuai template</label>
														<div></div>
														<div class="custom-file">
															<input type="file" name="fileku" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
														</div>
													</div>
													<div class="form-group mb-8">
														<label for="cars">Kategori </label>
														<select name="cars" id="cars" form="carform">
														<option value="volvo">Kepuasan Pelanggan</option>
														<option value="saab">User Experience</option>
														</select>
													</div>
													<a href="../asset/assets/kontak.xlsx" class="btn btn-success">Download Template (.xlsx)</a>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer">
														<input type="submit" name="upload" value="Kirim Survey" class="btn btn-primary mr-2"/>
														
                                                        <a href="<?php echo base_url(); ?>hasil/daftar_hasil" class="btn btn-secondary">Cancel</a>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-custom gutter-b example example-compact">
                                            <div class="card-header">
                                                <h3 class="card-title">Single Survey</h3>
                                                
                                            </div>
											<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>hasil/send_satu" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="form-group mb-8">
                                                        <label>
                                                        No. Whatsapp Pelanggan
                                                        </label>
                                                        <input type="number" class="form-control" placeholder="628XXXXXXX" name="mdn">
                                                    </div>
													<div class="form-group mb-8">
                                                        <label>
                                                        ID Pelanggan
                                                ...
                                                <div class="card-footer">
                                                    <button type="submit" class="btn btn-primary mr-2">Kirim Survey</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
						...
						<?php
							if($this->session->flashdata('pop') == 1)
								{ ?>													
									<div class="alert alert-success alert-dismissible">
										<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
										<h4><i class="icon fa fa-check"></i> Survey telah dikirim</h4>
										Terima Kasih
									</div>
							<?php }
							if($this->session->flashdata('pop') == 2)
								{ ?>
									<div class="alert alert-warning alert-dismissible">
										<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
										<h4><i class="icon fa fa-check"></i> Survey telah dikirim</h4>
										Terdapat Nomor yang telah disurvey sebelumnya
									</div>
							<?php	}
							?>					
