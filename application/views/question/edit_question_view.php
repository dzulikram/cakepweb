							...
							<div class="container">
								...
								<div class="col">
                                        <div class="card card-custom gutter-b example example-compact">
											...
											<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>question/aksi_ubah_question/<?php echo $satu_id; ?>" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="form-group mb-8">
														<input type="hidden" class="form-control" name="id">
														<textarea name="question" rows="10" cols="70"><?php echo $satu_quest; ?></textarea>
                                                    </div>													
                                                </div>
                                                <div class="card-footer">
                                                    <button type="submit" class="btn btn-primary mr-2">Update</button>
													<a href="<?php echo base_url(); ?>question/daftar_question" class="btn btn-secondary">Cancel</a>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
