...
class Node_model extends CI_Model {
    ...
    private $table = "node";
    private $primary_key = "node_id";
    private $status_aktif = "node_isaktif";
    ...
    public function getAllDetail() {
        $data = $this->db->query('select * from node,media,unit where media.media_id = node.media_id and node.unit_id = unit.unit_id');
        return $data->result();
    }
